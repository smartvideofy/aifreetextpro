      ...
      <main className="min-h-screen pt-20">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <article className="prose prose-lg max-w-none">
            ...
            <p>We tested both detectors against 250 samples: 50 each from ChatGPT, Claude, Gemini, Perplexity, and DeepSeek, plus 50 human-written control samples. <strong>Test window: 1-6 March 2026</strong>, on the detectors' then-current models. Both vendors ship updates without notice, so we re-run this set quarterly and date the table rather than presenting it as permanent.</p>

            <div className="overflow-x-auto my-6">
              <table className="w-full border-collapse border border-border">
                <thead><tr className="bg-muted"><th className="border border-border p-3 text-left">AI Model</th><th className="border border-border p-3 text-center">Turnitin</th><th className="border border-border p-3 text-center">Copyleaks</th><th className="border border-border p-3 text-center">Winner</th><th className="border border-border p-3 text-center">Tested</th></tr></thead>
                <tbody>
                  <tr><td className="border border-border p-3">ChatGPT</td><td className="border border-border p-3 text-center">94%</td><td className="border border-border p-3 text-center">89%</td><td className="border border-border p-3 text-center font-semibold">Turnitin</td><td className="border border-border p-3 text-center">2026-03-06</td></tr>
                  <tr><td className="border border-border p-3">Claude</td><td className="border border-border p-3 text-center">89%</td><td className="border border-border p-3 text-center">85%</td><td className="border border-border p-3 text-center font-semibold">Turnitin</td><td className="border border-border p-3 text-center">2026-03-06</td></tr>
                  <tr><td className="border border-border p-3">Gemini</td><td className="border border-border p-3 text-center">87%</td><td className="border border-border p-3 text-center">84%</td><td className="border border-border p-3 text-center font-semibold">Turnitin</td><td className="border border-border p-3 text-center">2026-03-06</td></tr>
                  <tr><td className="border border-border p-3">Perplexity</td><td className="border border-border p-3 text-center">82%</td><td className="border border-border p-3 text-center">79%</td><td className="border border-border p-3 text-center font-semibold">Turnitin</td><td className="border border-border p-3 text-center">2026-03-06</td></tr>
                  <tr><td className="border border-border p-3">DeepSeek</td><td className="border border-border p-3 text-center">78%</td><td className="border border-border p-3 text-center">73%</td><td className="border border-border p-3 text-center font-semibold">Turnitin</td><td className="border border-border p-3 text-center">2026-03-06</td></tr>
