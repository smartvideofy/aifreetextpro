  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="We ran one essay through 7 free AI humanizers, then tested each on Turnitin, GPTZero and Originality.AI. Winner: 96% bypass, no signup, 5,000 words/day." />
