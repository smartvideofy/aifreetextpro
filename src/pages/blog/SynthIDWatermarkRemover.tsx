      ...
      <main className="pt-20 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <article className="prose prose-lg max-w-none">
            ...
            <p>So all four combinations exist. Text can be watermarked and pass a detector. It can be unwatermarked and get flagged as AI. A human essay with tight, uniform sentences can be flagged even though no watermark exists anywhere in it. If you have been accused on detector evidence alone, our guides on <Link to="/blog/ai-detection-false-positives">AI detection false positives</Link> and the <Link to="/blog/turnitin-appeal">Turnitin appeal process</Link> cover what to do.</p>
