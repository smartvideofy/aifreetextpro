...
const HumanizeAITextFreeNoSignup = () => {
  return (
    <>
      ...
      <PostHowToSchema
        url="https://aifreetextpro.com/blog/humanize-ai-text-free-no-signup"
        name="How to Humanize AI Text Free (No Signup)"
      ...
      <AuthorSchema
        articleUrl="https://aifreetextpro.com/blog/humanize-ai-text-free-no-signup"
