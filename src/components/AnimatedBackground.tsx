const AnimatedBackground = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true" style={{ contain: 'layout style paint' }}>
      ...
      {/* Subtle grid pattern - uses contain to prevent layout shifts */}
      <div 
