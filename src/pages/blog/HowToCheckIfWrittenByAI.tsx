...
const faqs = [
  { question: "How can I tell if AI wrote this?", answer: "Look for four signals together: sentence lengths clustered between 15 and 25 words, generically competent vocabulary with no jargon or slang, a rigid intro-three-points-conclusion structure, and no concrete personal detail. Any one signal alone proves nothing; three or more in a 500-word passage is a strong indication AI drafted the text. Confirm with two detectors before acting on it." },
  { question: "How do you detect AI writing?", answer: "Detect AI writing in three passes. First, run the passage through a detector to get a baseline probability. Second, measure sentence-length variance across ten consecutive sentences; AI output clusters tightly while human writing swings between 6-word and 40-word sentences. Third, look for specificity: real authors name people, dates, prices, and places from memory, and AI drafts almost never do. Agreement across all three passes is what makes a judgement defensible." },
  { question: "Was this written by AI? How do I know for sure?", answer: "You cannot know for certain from the text alone, and no honest tool claims otherwise. What you can do is raise confidence: two independent detectors agreeing above 80%, three or more manual signals present, and no revision history in the document together make AI authorship very likely. Absent revision history or an author who can discuss their own reasoning is usually stronger evidence than any single score." },
  { question: "What is the best AI writing checker?", answer: "For unedited text, AI Free Text Pro's free checker and GPTZero both score around 88-92% accuracy in our March 2026 testing, with Copyleaks close behind. No checker is reliable on humanized or heavily edited text, so use the score as one input rather than a verdict." },
  { question: "Can you detect AI writing without a tool?", answer: "Yes, for unedited output. Read for sentence-length variance, missing specifics, absent personal voice, and hedged conclusions. Experienced teachers and editors identify unedited AI drafts by ear at rates comparable to detectors, and unlike detectors they can weigh context such as the writer's previous work." },
  { question: "Can I check if something was written by AI for free?", answer: "Yes. Several tools offer free tiers, including AI Free Text Pro's detector (1,000 free words), GPTZero (10,000 characters/month free), and Copyleaks (limited free scans). For occasional checking, free tools are sufficient." },
