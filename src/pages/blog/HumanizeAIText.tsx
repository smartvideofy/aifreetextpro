...
const HumanizeAIText = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <PostHowToSchema
        url="https://aifreetextpro.com/blog/humanize-ai-text-without-losing-voice"
        name="How to Humanize AI Text Without Losing Your Voice"
      ...
      <AuthorSchema
        articleUrl="https://aifreetextpro.com/blog/humanize-ai-text-without-losing-voice"
